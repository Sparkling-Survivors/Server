...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.CdsTryKillerBasicAttack, MakePacket<CDS_TryKillerBasicAttack>);
		_handler.Add((ushort)MsgId.CdsTryKillerBasicAttack, PacketHandler.CDS_TryKillerBasicAttackHandler);
	}
